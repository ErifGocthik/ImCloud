...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    surname = models.CharField(max_length=256, blank=False, null=False, verbose_name='Имя')
    patronymic = models.CharField(max_length=256, blank=True, null=True, verbose_name='Имя')
    email = models.EmailField(blank=False, null=False, unique=True, verbose_name='Электронная почта')
    role = models.IntegerField(blank=True, null=False, verbose_name='Роль')
    design_id = models.ForeignKey(Design, models.CASCADE, verbose_name='Дизайн')
    ...
    subscribe = models.BooleanField(default=0, blank=True, null=False, verbose_name='Подписка')
...
class Image(models.Model):
    ...
    format = models.CharField(max_length=6, blank=False, null=False, verbose_name='Формат изображения')
    ...
    user_id = models.ForeignKey(CustomUser, on_delete=models.CASCADE, verbose_name='Пользователь')
    archive_id = models.ForeignKey(Archive, on_delete=models.CASCADE, verbose_name='Архив')
